		  ...
		  <a name="frequently-asked-questions"></a>
           ...
           <a name="what-are-elements-of-an-implementation-strategy"></a>
            ...
            <ul class="bullet-size-fix">
                ...
                <li>Identifies adaptive management elements, processes, and decision makers</li>
...
<h2>WHO DEVELOPS IMPLEMENTATION STRATEGIES?</h2>
            ...
            <p>Additional information about the Strategies and related Puget Sound recovery efforts is managed and publicly available in <a href="http://www.MiradiShare.org">Miradi Share</a>™, an online database that supports development, monitoring, and sharing of information among conservation practitioners, project and program managers, and funders. Miradi project files for all completed Strategies are available in the links below. Most projects are publicly viewable without a Miradi account. For more details and the ability to download project information files, go to <a href="http://www.MiradiShare.org">www.MiradiShare.org</a> and create a free account. For access questions, please contact Wessyl Kelly at <a href="mailto:wessyl.kelly@psp.wa.gov">wessyl.kelly@psp.wa.gov</a>.</p>
            <ul class="bullet-size-fix">
