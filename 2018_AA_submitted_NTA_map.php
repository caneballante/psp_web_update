...
<div class="container-fluid page-content padding-50-bottom">
	<div class="row">
		...
		<div class="col-sm-7 padding-20-top"> <!-- InstanceBeginEditable name="6col_header" -->
			<h1>MAP OF NEAR TERM ACTIONS</h1>
	...
	<div class="row"> 
		...
		<p>The map below shows the locations of all submitted NTAs to be reviewed and evaluated for adoption into the 2018-2022 Action Agenda. <br>
			The map differentiates between actions that are site specific (such as direct on-the-ground restoration or protection activities), or non-restoration/non site-specific actions (such as planning processes or desktop mapping). For non-site specific actions, the location indicates the office location where the funds would be spent if the NTA were to be funded.</p>
