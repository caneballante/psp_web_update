...
<div class="container-fluid page-content padding-50-bottom">
	...
	<div class="row"> 
		...
		<ul class="bullet-size-fix">
			...
			<li><strong>The Implementation Plan</strong>, which is the action  component of the Action Agenda and provides the shared focus and implementation  guidance for recovery over the next four years. Organized by strategies, it  describes how we will make progress toward the Action Agenda desired outcomes,  the Puget Sound Vital Signs, and statutory recovery goals. The Implementation  Plan is the product of the collective recovery community effort to focus on the  most important actions to achieve the desired outcomes.</li>
		</ul>
		...
		<!-- LAST UPDATED -->
		<p class="last-update">Last updated: 06/06/22</p>
