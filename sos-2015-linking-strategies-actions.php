...
<header class="overview-page-image-style overview-page-image85">
...
<div class="container page-content padding-50-bottom">
	<div class="row">
		...
		<div class="col-sm-7 padding-20-top"> <!-- InstanceBeginEditable name="6col_header" -->
			<h1>LINKING STRATEGIES AND ACTIONS</h1>
	...
	<div class="row"> 
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
		  ...
		  <p>The goals of this study were to:</p>
		 <ul><li>Systematically document the recovery effort represented by the 2012 Action Agenda.</li>
		  <li>Show how the recovery effort is linked to recovery goals.</li>
		  <li>Evaluate how recovery effort contributes to progress toward the recovery goals.</li></ul>
          <img class="img-responsive" src="images/linkages.png" />
		<p>The study is guided by the following questions:</p>
		  <ol><li>What did the Partnership plan to do and invest in for the 2012 Action Agenda?</li>
		 <li>What did the Partnership actually do and invest?</li>
		  <li>Did the planned actions and investments have any bearing on the progress in the Vital signs?</li></ol>
		  
		  <p>The scope of the study also includes:</p>
		  <ul><li>An exploration of how some factors affect NTA implementation</li>
		  <li>A discussion of implications for planning, evaluation and adaptive management</li>
		  <li>Recommendations for improvements to how the Partnership defines and evaluates recovery efforts.</li></ul>
		 
		 <p>Documenting and evaluating connections between effort and progress is intended to inform and strengthen regional adaptive management and the Partnership’s recovery planning.</p>
	    <p><a href="https://pspwa.box.com/HershmanFellowGraziano" target="_blank">Find the report here.</a></p>
		<!-- InstanceEndEditable --> </div>
