		...
		<h3 class="margin-0-top">TWO FORCES TO BE RECKONED WITH</h3>
			...
			<table width="800" border="0" class="table padding-10-all">
				<tbody>
					...
					<tr>
						<td><ul>
							<li>Air temperature increased by about +1.3°F between 1895 and 2011</li>
							<ul></td>
						<td><ul>
								<li>Even warmer temperatures, more extremes in weather, more droughts</li>
							</ul></td>
					</tr>
					<tr>
						<td><ul>
								<li>Precipitation totals (rain or snow) stayed about the same, with no significant trend</li>
							</ul></td>
						<td><ul>
								<li>Small changes in precipitation, with heavy rainfall becoming more extreme</li>
							</ul></td>
					</tr>
					<tr>
						<td><ul>
								<li>Snowpack thinned, glacial area decreased, most Washington glaciers are in decline</li>
							</ul></td>
						<td><ul>
								<li>Spring snowpack will decline</li>
							</ul></td>
					</tr>
					<tr>
						<td><ul>
								<li>Streamflows are peaking earlier in the year for many snowmelt-influenced rivers in the Pacific Northwest as a result of decreased snow accumulation and earlier spring melt</li>
							</ul></td>
						<td><ul>
								<li>Streamflows will peak even earlier</li>
								<li>Winter streamflow will increase</li>
								<li>Summer streamflow will decrease</li>
								<li>More floods</li>
								<li>Lower summer low flows</li>
							</ul></td>
					</tr>
					<tr>
						<td><ul>
								<li>Sea level is rising at most locations. Local sea level changes range from a decline along the northwest Olympic peninsula, a region experiencing uplift, to sea level rise in parts of the Puget Sound and the outer coast where land is subsiding</li>
							</ul></td>
						<td><ul>
								<li>Coastal areas in Washington will experience sea level rise, with perhaps the exception of areas like the northwest Olympic Peninsula, where the land is uplifting</li>
							</ul></td>
					</tr>
					<tr>
						<td><ul>
