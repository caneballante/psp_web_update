      ...
      <!--   <div class="row">
        ...
        <div class="row">
				...
				<h2 class="margin-2-top">2020 Virtual Puget Sound Days on the Hill</h2>
					...
					<p><strong>Advanced registration for this event is required and will close 24 hours before the event, on Thursday, June 9 at 1 p.m. Pacific Time. Please <a href="https://nwifc.org/psdoth/">click here to register</a> for the July 10 session.</strong></p>
