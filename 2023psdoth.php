...
<div class="container-fluid page-content padding-50-bottom">
	<div class="row">
		...
		<div class="col-sm-7 padding-20-top"> <!-- InstanceBeginEditable name="6col_header" -->
			<h1>2023 Puget Sound Day on the HIll</h1>
	...
	<div class="row"> 
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
			<h2 class="margin-0-top">Raising awareness to recover Puget Sound!</h2>
			<p>Dates: May 8-11, 2023</p>
			<p>Location: Washington, D.C.</p>
			<p>Join us! Puget Sound Day on the Hill raises awareness about the need for sustained federal investment in Puget Sound restoration and salmon recovery. Representatives from tribes, state agencies, local governments, nonprofits, and businesses, along with concerned residents, lend their voices in support of action to save Puget Sound and uphold tribal treaty rights.</p>
			<p><a href="https://docs.google.com/forms/d/e/1FAIpQLSf3wmHgEdvBUcLv8RGOphoB5GR8q6PX4WxgNA0e5zOyYVJvKg/viewform" target="new" class="btn btn-default btn-lg" role="button">Register Now</a></p><br>

			<p>We are asking individuals, governments, and organizations to demonstrate their support by signing on to our federal appropriations requests. To be included as an official signatory to any of the letters, please complete this form by 5pm, Friday March 24th</p>
			<p><a href="https://docs.google.com/forms/d/e/1FAIpQLSeEpwjE5cdm6Tz6dgwgofErozrjForaV76mWobh_4djU_D3rA/viewform" target="new" class="btn btn-default btn-lg" role="button">Sign the Letter</a></p><br>
