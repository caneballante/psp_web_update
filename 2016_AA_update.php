	...
	<div class="row">
		<div class="col-md-3">
			<ul class="nav nav-stacked nav-pills nav-leftside-custom padding-left-0 margin-10-top margin-left-20">
				...
				<li class="active" role="presentation"> <a href="2016_AA_update.php">2016 ACTION AGENDA UPDATE</a></li>
				...
				<li role="presentation"> <a href="2016_AA_SITT.php">STRATEGIC INITIATIVE TRANSITION TEAMS</a></li>
