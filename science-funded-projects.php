...
<br>
    ...
    <!-- Div to Display Selected Primary Goal -->
 	<div id="custom-table-title"></div>
		  ...
		  <thead>
			  <tr>
				<th><button class="btn btn-default">Title</button></th>
				<th><button class="btn btn-default">Description</button></th>
				<th><button class="btn btn-default">Point of Contact</button></th>
				<th><button class="btn btn-default">Affiliation</button></th>
				<th><button class="btn btn-default">Biennium</button></th>
				<th><button class="btn btn-default">Funding Source</button></th>
				<th><button class="btn btn-default">Link</button></th>
			  </tr>
			</thead>
			<tbody>
        ...
        <!-- LAST UPDATED -->
		<p class="last-update">Last updated: 7/10/2025</p>
