	...
	<!--
		<div class="highlightbox">
            ...
            <p>The  SFT assists Tribes, Local Integrating Organizations (LIOs), Lead Entities  (LEs), and other local partners in responding to rapid funding availabilities that  support the implementation of the <a href="https://psp.wa.gov/2022AAupdate.php">Action  Agenda</a> and <a href="https://psp.wa.gov/salmon-recovery-overview.php">Salmon  Recovery Plan</a>, our community&rsquo;s shared recovery plans for Puget Sound.&nbsp;</p>
             <p> The SFT supports the efforts of the  recovery community to plan and act across sectors and geographies to align  transportation, land use, habitat restoration and protection, agriculture,  climate change mitigation, flood hazard reduction, and stormwater  infrastructure to achieve a multi-benefit approach.</p>
            <p> Additionally, we will align state and  federal programs and increase investments that support Puget Sound recovery and  Tribal and local priorities.</p>
