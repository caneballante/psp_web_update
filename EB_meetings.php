...
<title>Puget Sound Partnership - Ecosystem Coordination Board Meetings and Agendas</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap -->
	...
	<div class="row"> 
		<div class="col-md-3">
			...
			<!-- InstanceBeginEditable name="left_nav" -->
				...
				<li class="active" role="presentation"> <a href="EB_meetings.php">ECOSYSTEM COORDINATION BOARD MEETINGS AND AGENDAS</a></li>
		...
		<!-- InstanceBeginEditable name="6col_content" -->
			...
			<table width="100%" border="0" class="table">
				<tr>
					<td width="148" class="tableheader">DATE</td>
