...
<div class="container-fluid page-content padding-50-bottom">
	...
	<div class="row"> 
        ...
        <ul class="bullet-size-fix">
          ...
          <li>PSP Science Panel</li>
          <li>The Puget Sound Salmon Recovery Council</li>
        ...
        <ul class="bullet-size-fix">
          <li>The type of growth and development patterns being  explored.</li>
        ...
        <p>A housing affordability tool determines how housing  affordability might change in each scenario. The tool uses land cover and  population information from Envision to form the basis of home value  predictions associated with factors such as conserved open space and density. </p>
        <h3>Additional Sub-Models</h3>
        <p>Several other sub-models help explore socioeconomic  activities and conditions beyond the QNM outputs:</p>
        <ul class="bullet-size-fix">
