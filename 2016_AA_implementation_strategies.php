	...
	<div class="row">
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
			...
			<ul>
				...
				<li>Assesses and combines elements of local and regional recovery efforts, ongoing programs, Near Term Actions from the <a href="action_agenda_center.php">Puget Sound Action Agenda</a>, and results from the <a href="http://wdfw.wa.gov/grants/ps_marine_nearshore/files/2014_puget_sound_pressures_assessment.pdf">Puget Sound Pressure Assessment</a>. </li>
			...
			<p>These pilot Strategies are testing approaches and generating findings that are contributing to a guidance document for development of future Strategies.</p>
				<p>We anticipate that the Estuaries and Shellfish Beds Strategies will be finished by January 2016. We expect the Chinook Strategy to be completed in December 2016. </p>
		...
		<p>Current and planned Strategies are intended to inform the 2018 Action Agenda. </p>
...
<p>Draft Strategies have been refined through multiple rounds of technical and stakeholder review. The materials used to develop the test-case Strategies are available in the links below:</p>
		...
		<ul>
			<li><strong><a href="#question1answer">What are the elements of an Implementation Strategy?</a></strong></li>
		<li><strong><a href="#question2answer">How do Implementation Strategies relate to the Action Agenda?</a></strong></li>
			<li><strong><a href="#question3answer">How do Implementation Strategies differ from Strategic Initiatives?</a></strong></li>
			<li><strong><a href="#question4answer">How is the order of Implementation Strategies determined?</a></strong></li>
			<li><strong><a href="#question5answer">Will Implementation Strategies be developed for all Vital Signs?</a></strong></li> 
			</ul><a name="question1answer"></a>
		...
		</ul><a name="question2answer"></a>
		<h2>How do Implementation Strategies relate to the Action Agenda?</h2>
			<p>The Strategies will support decisionmaking and provide guidance on the types of priority actions needed to meet the Vital Sign targets.</p>
...
<h2>How is the order of Implementation Strategies determined?</h2>
		...
		<p>To select the next six Vital Signs for which Strategies would be developed, the selection criteria were applied to all the remaining Vital Sign indicator targets. <br>
