...
<p><strong>Implementation Strategies</strong> are plans for achieving the Puget Sound 2020 <a href="http://www.psp.wa.gov/interim_targets.php">Ecosystem Recovery Targets</a>, which are associated with the <a href="http://www.psp.wa.gov/pm_dashboard.php">Puget Sound Vital Signs</a>. The plans are designed to inform the <a href="http://www.psp.wa.gov/action_agenda_center.php">Puget Sound Action Agenda</a>, the <a href="http://www.psp.wa.gov/sos.php">State of the Sound</a>, the <a href="http://www.psp.wa.gov/SP_biennium_work_plan_download.php">Biennial Science Work Plan</a>, the <a href="https://sites.google.com/a/psemp.org/psemp/">Puget Sound Ecosystem Monitoring Program</a>, and <a href="http://www.psp.wa.gov/SR_status.php">salmon recovery planning</a>.</p>
<p>Each plan accomplishes the following:</p>
				...
				<ul>
						...
						<li><strong>September 2015:</strong> The Estuaries and Shellfish bed Implementation Strategies drafts will be made available to the Strategic Initiative Transition Teams to help inform content for the 2016/2017 Action Agenda. The Chinook salmon Implementation Strategy is expected to take longer to develop but is underway as well. </li>
						<li><strong>August-Sept. 2015:</strong> Based on review and evaluation of the test-case Implementation Strategies, guidelines for creating future Implementation Strategies are being developed. </li>
				</ul>
...
<p><strong>How do Implementation Strategies differ from Strategic Initiatives? </strong><br />
		<img src="images/2015-strategic-icons_final.jpg" width="500" height="210" alt=""/>	<br />
