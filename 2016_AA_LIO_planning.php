	...
	<div class="row">
		<div class="col-md-3">
			<ul class="nav nav-stacked nav-pills nav-leftside-custom padding-left-0 margin-10-top margin-left-20">
				...
				<li class="active" role="presentation"> <a href="2016_AA_LIO_planning.php">LIO PLANNING</a></li>
...
<ul><li>LIOs will use these templates and guidance documents to develop plans and NTAs.</li></ul>
