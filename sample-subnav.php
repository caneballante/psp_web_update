...
&lt;/li&gt;</code></pre>
			...
			<p>The placeholder below has <code>id="sectionPager"</code>. Pages without that placeholder will keep using <code>custom.js</code> normally without showing next/back links.</p>
