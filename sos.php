...
<header class="overview-page-image-style overview-page-image3"> </header>
<!-- InstanceEndEditable -->  
	...
	<div class="row"> 
		<div class="col-md-3">
			...
			<!-- InstanceBeginEditable name="left_nav" -->
				...
				<li role="presentation"> <a href="#">SECTION THREE OF THE SOS</a></li>
				<li role="presentation"> <a href="#">SECTION FOUR OF THE SOS</a></li>
