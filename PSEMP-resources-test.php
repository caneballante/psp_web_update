		...
		<div class="container-fluid">
			...
			<div class="col-md-4">
				...
				<div class="col-md-4">
					...
					<span class="no-icon"><a href="https://vitalsigns.pugetsoundinfo.wa.gov/VitalSign/Detail/6"><img src="images/news-images/FallCityPSAR.jpg" class="img-responsive img-rounded" alt=""/></a> 
