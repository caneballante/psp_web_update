...
<div class="container padding-40-bottom" id="home-squares">
	...
	<div class="row"> 
		...
		<div class="col-sm-3 padding-10-top">
			...
			<div class="padding-5-bottom"><a href="PSAR.php">Puget Sound Acquisition and Recovery Fund (PSAR)</a></div>
			...
			<div class="col-md-3 col-sm-4">
				<div class="newsbox newsbox-with-img">
					<div class="newsbox-text"> 
						...
						<a href="https://pugetsoundinnovationstories.blog/">Learn about the people and projects saving Puget Sound</a><br>
						<!--END news content BOX--> 
					</div>
				</div>
			</div>
