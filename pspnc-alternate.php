...
<div class="container-fluid page-content padding-50-bottom">
	...
	<div class="row"> 
		...
		<div class="row">
			...
			<button class="button button1"><a href="/pspnc-credits.php" target="_blank" style="color:white"><p>Interested in purchasing conservation credits? Click here</p></a></button>
			<br>
			<br>
