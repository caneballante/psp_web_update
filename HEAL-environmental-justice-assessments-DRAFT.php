...
<div class="container-fluid page-content padding-50-bottom">
	<div class="row">
		...
		<div class="col-sm-7 padding-20-top"> <!-- InstanceBeginEditable name="6col_header" -->
			<h1>SIGNIFICANT AGENCY ACTION FOR Environmental Justice Assessments</h1>
	...
	<div class="row"> 
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
			...
			<p>The Partnership can  identify additional types of significant agency actions, in addition to the  above, which will require environmental justice assessments starting July 1,  2025. Our initial list of specific significant  agency actions include:</p>
