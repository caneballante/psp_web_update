	...
	<div class="row">
		<div class="align-center">
			<ul class="nav nav-pills">
				<li id="nav1" role="presentation"> <a href="sos_trashme.php">2015 STATE OF THE SOUND</a></li>
				<li id="nav2" role="presentation"> <a href="sos_trashme_1.php">ECOSYSTEM RECOVERY PROGRESS</a></li>
				<li id="nav3" role="presentation"> <a href="sos_trashme_1.php">ACTION AGENDA PROGRESS &amp; RECOMMENDATIONS</a></li>
				<li id="nav4" role="presentation"> <a href="sos_trashme_1.php">RESOURCES</a></li>
				<li id="nav5" role="presentation"> <a href="sos_trashme_1.php">DEFINITIONS</a></li>
			</ul>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="col-sm-3">
			<ul class="nav nav-stacked nav-pills nav-leftside-custom padding-left-0 margin-10-top">
				<li id="nav2" role="presentation"> <a href="sos-2015-ecosystem-recovery-progress.php">SECONDARY LINKS</a></li>
	<li id="nav3" role="presentation"> <a href="sos-2015-action-agenda-progress.php">SECONDARY LINKS</a></li>
	<li id="nav4" role="presentation"> <a href="sos-2015-resources.php">SECONDARY LINKS</a></li>
	<li id="nav5" role="presentation"> <a href="sos-2015-definitions.php">SECONDARY LINKS</a></li>			</ul>
		</div>
		<div class="col-sm-7 padding-20-top content-column">
			...
			<ul>
				...
				<li>What have we learned and what are our next steps?</li>
			</ul>
