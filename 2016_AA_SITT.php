...
<title>Puget Sound Partnership - 2016 Action Agenda Update Strategic Initiative Transition Teams</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap -->
	...
	<div class="row"> 
		...
		<!-- InstanceBeginEditable name="6col_content" -->
			...
			<ul>
				...
				<li><a href="http://www.psp.wa.gov/action_agenda_strategic_initiatives.php">Strategic Initiatives</a></li>
				<li><a href="http://www.psp.wa.gov/2016_AA_implementation_strategies.php">Implementation Strategies</a></li>
				<li><a href="http://www.psp.wa.gov/2016_AA_LIO_planning.php">Local Integrating Organization (LIO) planning</a></li>
			</ul>
			<!-- InstanceEndEditable -->
		</div>
