			...
			<div class="col-md-3">
				<div class="newsbox">
					<div class="newsbox-text"> 
						...
						<a href="https://content.govdelivery.com/accounts/WAPSP/bulletins/1864bd8" target="new">WEEK 6 LEGISLATIVE CALENDAR</a><br>
						<!--END news content BOX--> 
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="newsbox">
					<div class="newsbox-text"> 
						...
						<a href="https://content.govdelivery.com/accounts/WAPSP/bulletins/18540b3" target="new">NEWS FROM AROUND THE SOUND RELATED TO PUGET SOUND RECOVERY</a><br>
						<!--END news content BOX--> 
					</div>
				</div>
			</div>
