	...
	<div class="row"> 
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
			...
			<h2>Implementation Effectiveness</h2>
				...
				<h2>Results</h2>
				<p>	The Partnership reports the current status of both ecosystem health and implementation effectiveness in the&nbsp;<a href="http://www.psp.wa.gov/sos.php">State of the Sound report</a>, updated every 2 years. The report provides a summary of data tracked in the Puget Sound Vital Signs and Action Agenda Tracker to help partners and decision makers understand the state of the Puget Sound ecosystem, where progress is being made, where challenges remain, and where future action and focused investment are needed.</p>
