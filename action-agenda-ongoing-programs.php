...
<div class="container page-content padding-50-bottom">
	<div class="row">
		...
		<div class="col-sm-7 padding-20-top"> <!-- InstanceBeginEditable name="6col_header" -->
			<h1>3.0 Directory of Ongoing programs</h1>
	...
	<div class="row"> 
		...
		<div class="col-sm-2 padding-20-top padding-0-right"> <!-- InstanceBeginRepeat name="right_nav_repeat" --><!-- InstanceBeginRepeatEntry --> <!-- InstanceBeginEditable name="right_nav_title" -->
			...
			<ul class="nav-rightside-custom">
				...
				<li role="presentation"> <a href="action-agenda-2016-document.php" target="_blank">2016 Action Agenda Document 2.0</a></li>	<li role="presentation"> <a href="action-agenda-who.php" target="_blank">Who makes it 1.3</a></li>
				<li role="presentation"> <a href="action-agenda-how-is-it-paid-for.php" target="_blank">How is it paid for 1.6</a></li>
				<li role="presentation"> <a href="#" target="_blank">Infographic -- pies charts showing statistics on ongoing programs - e.g., distribution between federal, state, local, tribes, Academia, and NGO</a></li>
				<!-- InstanceEndEditable -->
			</ul>
