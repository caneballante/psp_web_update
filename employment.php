	...
	<div class="row"> 
		...
		<ul class="bullet-size-fix">
			...
			<li>Infant-at-Work program </li>
			 ...
			 <img src="images/Employer-of-choice.jpg" width="650" height="610" alt="Puget Sound Partnership employer of choice benefits"/><br>
		<br>
		<br>
		<br>
		<br>
			...
			<ul class="nav-rightside-custom">
				...
				<li>
					<p>Jennifer Carlson<br>
					  <em>Agency Workplan and EPA Grant Manager</em><br />
						360.819.0530 <br>
					  <a href="mailto:jennifer.carlson@psp.wa.gov">jennifer.carlson@psp.wa.gov</a></p>
				</li>
				<!-- InstanceEndEditable -->
			</ul>
