...
<div class="container page-content padding-50-bottom">
	...
	<div class="row"> 
		...
		<h3>City of Everett—Let it Rain—Green Stormwater Infrastructure Program</h3>
		  ...
		  <p><img class="pull-right img-responsive padding-10-left" src="images/ne-rain-garden.png" />The City of Everett will continue these basic programs through 2015 and periodically provides tours of residential rain gardens as shown in the photo below. In addition, the City has added an element of public-private partnership in helping pay for disconnection of stormwater from the combined sewer system. This project, in Jackson Park, is currently underway.</p>
		<h3>King County--Upper Carlson Floodplain Restoration Project</h3>
	    <p>During 2014, King County removed a 1600-foot long levee and revetment and constructed a new 1,200-foot long revetment that is now adjacent to Neal Road. These actions have begun to restore natural river processes along this reach of the Snoqualmie River that will form habitat features like gravel bars and logjams to provide spawning and rearing habitat for salmon. The project also reconnected the river with 50 acres of forested floodplain. In addition, 16 acres of knotweed were treated and replanted with about 11,000 native trees and shrubs. The project addresses high-priority salmon habitat restoration needs for the threatened Snoqualmie Chinook populations, steelhead, other salmon species and wildlife.</p>
	    <img class="img-responsive" src="images/king-county-upper-carlson.png" />
