	...
	<div class="row"> 
		<div class="col-md-3">
			...
			<!-- InstanceBeginEditable name="left_nav" -->
				<li class="active" role="presentation"> <a href="#">SCIENCE OVERVIEW</a></li>
				<li role="presentation"> <a href="#">STRATEGIC SCIENCE PLAN</a></li>
				<li role="presentation"> <a href="#">ADAPTIVE FRAMEWORK</a></li>
				<li role="presentation"> <a href="#">OPEN STANDARDS</a></li>
				<li role="presentation"> <a href="#">BIENNIAL SCIENCE WORKPLAN</a></li>
				<li role="presentation"> <a href="#">SCIENCE-BASED DECISION MAKING</a></li>
		...
		<!-- InstanceBeginEditable name="6col_content" -->
			...
			<p>s libero. Nunc vestibulum eu nisi a hendrerit. Mauris maximus, sapien eu mollis volutpat, sem ante venenatis ipsum, et sollicitudin elit est id ex. Morbi quis consectetur eros, eu tristique mi. Quisque tincidunt id risus vel porta. Praesent sit amet dolor volutpat, sagittis nisi non, porta elit.<br>
				<br>
				<br>
				<br>
				<br>
		...
		<div class="col-md-2 padding-20-top"> 
			...
			<!-- InstanceEndRepeatEntry --><!-- InstanceBeginRepeatEntry --> 
				<!-- InstanceBeginEditable name="right_nav_title" -->
					<h3 class="margin-0-top">RELATED DOCUMENTS</h3>
				<!-- InstanceEndEditable -->
					<ul class="nav-rightside-custom">
						<!-- InstanceBeginEditable name="right_nav_links" -->
					<li role="presentation"> <a href="#">LINKS</a></li>
