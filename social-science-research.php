...
<div class="container-fluid page-content padding-50-bottom">
	...
	<div class="row"> 
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
			<h2 class="margin-0-top">SOCIAL SCIENCE RESEARCH</h2>
			<p>Social science research provides useful information to inform the design of programs, evaluates the progress of recovery actions, informs policy decisions, and further explores the relationship between people and their environment. </p>
			...
			<h3>HUMAN DIMENSIONS</h3>
			<p>Human dimensions refers to the full spectrum of ways in which people relate to the environment including actions and behaviors that affect the health of the Sound as well as the ways in which people benefit from engagement with the natural environment of Puget Sound &#40;e.g., <a href="https://www.psp.wa.gov/evaluating-human-wellbeing.php">human wellbeing</a>&#41;. Human dimensions reflect the complex reciprocal relationship and interactions between humans and the natural environment, including interactions connected to all things social, cultural, linguistic, behavioral, political, economic, psychological, and geographic. The application of human dimensions in ecosystem recovery takes many forms, which include considering, monitoring, and measuring human wellbeing as an aspect of ecosystem health and vitality. Examples include, but are not limited to: &#40;1&#41; the <a href="http://www.shorefriendly.org/shoreline-ecosystem/">negative impacts</a> human-constructed shoreline infrastructure &#40;e.g., hard armor&#41; has on nearshore habitat and natural landscapes; &#40;2&#41; the <a href="https://frontandcentered.org/ej-map/">inequitable impacts</a> environmental health risks have on Washington communities; and &#40;3&#41; the positive impacts of <a href="https://vitalsigns.pugetsoundinfo.wa.gov/VitalSignIndicator/Detail/39">sense of place</a> on pro-environmental stewardship in Puget Sound. The Puget Sound Partnership in collaboration with <a href="https://kellybiedenweg.weebly.com/">Oregon State University</a>, Northern Economics, Inc., and other partners developed the <a href="https://pspwa.app.box.com/file/682489538078">Human Dimensions Protocol</a> as a guide to integrate human dimensions into regional planning efforts &#40;<a href="https://psp.wa.gov/implementation-strategies.php">Implementation Strategies</a>&#41;.</p>
			<h3>HUMAN WELLBEING</h3>
			<p>The <a href="evaluating-human-wellbeing.php">Human Wellbeing Vital Signs</a> address the recovery goals for a healthy human population and vibrant human quality of life, particularly as they relate to people&rsquo;s engagement with the natural environment of Puget Sound. The Vital Signs include familiar aspects of human health that contribute to our wellbeing, such as physical and psychological health, as well as social, cultural, and economic wellbeing and governance, or the way that people participate in decision-making.</p>
			<h3>SOCIAL SCIENCES ADVISORY COMMITTEE</h3>
			<p>The Partnership’s Science Panel established the Puget Sound Social Sciences Advisory Committee (SSAC) in 2010. The SSAC engages social scientists from many disciplines to inform and support Partnership goals and advise the Science Panel on matters related to the social sciences, salmon, and ecosystem recovery. Committee members include social scientists, both academics and professionals, from the Puget Sound region. The SSAC meets regularly to discuss advancements in social sciences research and monitoring, guide additional Puget Sound priority social sciences work, review Partnership materials, and provide a liaison to the Science Panel. The SSAC also informs the work of the Puget Sound Institute (PSI) in support of recovery efforts.</p>
			...
			<ul>
				<li><p><strong>SOUND BEHAVIOR INDEX</strong></p>
					<p>Surveys to measure behavior related to yard care, car maintenance, home maintenance, pet/animal waste, onsite septic systems, small farms, and recreational boating and fishing were conducted in 2012, 2013, and 2015. In addition, the first survey established the baseline and included a segment asking about social capital, or the value of social connectedness.  The Sound Behavior Index is part of the <a href="http://www.psp.wa.gov/evaluating-vital-signs.php">Sound Stewardship Vital Sign</a> and will continue to be monitored. Sound Behavior Index reports are available <a href="https://pspwa.box.com/s/45tqlfh4w6qidabkzlr21jy3y82xv0po" target="new">here</a>. </p>
				
				</li>
				<li><p><strong>GENERAL PUBLIC OPINION SURVEY</strong></p>
					<p>The General Opinion Survey focused on people&rsquo;s general knowledge, attitudes, beliefs, and sense of place related to Puget Sound. Conducted in 2012, 2013, and 2015, the surveys helped identify characteristics of the population useful for developing various stewardship activities. The surveys informed the <a href="http://www.pugetsoundstartshere.org/" target="new">Puget Sound Starts Here</a> campaign and provided pilot data related to the new Human Wellbeing Vital Sign indicators. Public Opinion surveys are available <a href="https://pspwa.box.com/s/uybht4wqvv0q04t6nltnsp9uyo9j6r3e" target="new">here</a>. </p>
					<div>
						<div> </div>
					</div>
				</li>
				<li><p><strong>BARRIERS AND MOTIVATORS SURVEY</strong></p>
					<p>Three surveys concentrated on practices related to a healthy Sound were carried out in 2012 to better understand barriers and motivators to these practices. After the surveys, researchers conducted follow-up focus groups to gain deeper perspectives into people&rsquo;s barriers to and motivations for Sound-healthy practices. Barriers and Motivators Surveys are available<a href="https://pspwa.box.com/s/ja2gk1ewp6do4iqm1sfp8kqdtx8rv96d" target="new"> here.</a></p>
					<div>
						<div> </div>
					</div>
				</li>
