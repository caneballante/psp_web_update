	...
	<div class="row"> 
		<div class="col-md-3">
			...
			<!-- InstanceBeginEditable name="left_nav" -->
				...
				<li role="presentation"> <a href="#">REPORT CARD</a></li>
				<li role="presentation"> <a href="#">PROJECT ATLAS/NEP ATLAS</a></li>
				<li role="presentation"> <a href="#">ADAPTIVE MANAGEMENT</a></li>
