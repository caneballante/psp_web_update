...
<p>On an annual basis, each of the watershed groups representing the 15 watershed chapters of the Puget Sound Salmon Recovery Plan develop 4-year work program updates to describe the watershed’s accomplishments during the previous year, identify the current status of recovery actions, and to propose future actions and any changes in recovery strategies in the next 4 years necessary to implement the Salmon Recovery Plan. <a href="salmon-four-year-work-plans.php">LEARN MORE</a></p>
