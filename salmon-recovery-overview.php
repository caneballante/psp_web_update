...
<div class="container-fluid page-content padding-50-bottom">
	<div class="row">
		...
		<div class="col-sm-7 padding-20-top"> <!-- InstanceBeginEditable name="6col_header" -->
			<h1>Salmon Recovery IN PUGET SOUND		Overview	</h1>
	...
	<div class="row"> 
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
			...
			<p>The health of  salmon populations reflects the overall health of Puget Sound. At the Puget  Sound Partnership, we play an  important role in salmon recovery by investing in related projects and helping  to coordinate and track the work of local, Tribal, and regional partners.  Working closely with <a href="/tribal-relations.php" target="new">Tribal nations</a> and partners is vital to  achieving our collective goal of protecting and restoring critical salmon  habitat to support their recovery.
We lead these efforts in the  following ways (select each one for more information):</p>
        <ul class="bullet-size-fix">
			<li><strong><a href="/salmon-recovery-science.php" target="new">Science</a></strong> - Share information, connect science to action, adapt  recovery efforts as we learn more</li>
              ...
              <li><strong><a href="/HEAL.php" target="new">Environmental Justice</a></strong> - Keep environmental justice at the  center of salmon recovery efforts.</li>
            </ul>
        <h2>Our  Goals</h2>
