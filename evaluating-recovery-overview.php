		...
		<div class="col-md-3 padding-20-top"> 
			<!-- InstanceBeginRepeat name="right_nav_repeat" --><!-- InstanceBeginRepeatEntry --> 
				...
				<!-- InstanceEndEditable -->
					...
					<li class="active" role="presentation"> <a href="science-basis-of-recovery-overview.php">SCIENCE BASIS OF RECOVERY OVERVIEW</a></li>
					<li role="presentation"> <a href="science.php">SCIENCE </a></li>
					<li role="presentation"> <a href="science-resources.php">SCIENCE RESOURCES</a></li>
