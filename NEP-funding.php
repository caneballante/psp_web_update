...
<p>Funds allocated by Congress vary annually.</p>
			<ul>
				...
				<li>EPA enters into cooperative inter-agency agreements with other federal natural resources management organizations to support Puget Sound protection and restoration goals under the Clean Water Act-National Estuary Program.</li>
				<li>EPA supports operations and staffing from this annual allocation. </li>
			...
			<p>The Puget Sound Partnership matches the federal investment in Puget Sound recovery on a 1:1 basis from a variety of state funding sources: state general fund, the <a href="https://rco.wa.gov/grant/aquatic-lands-enhancement-account/">Aquatic Lands Enhancement Account (ALEA</a>), the <a href="http://www.psp.wa.gov/PSAR.php">Puget Sound Acquisition and Restoration (PSAR) Fund</a>, and the <a href="https://ecology.wa.gov/Spills-Cleanup/Contamination-cleanup/Rules-directing-our-cleanup-work/Model-Toxics-Control-Act">Model Toxics Control Act (MTCA)</a>.  Salmon recovery is also supported through the <a href="https://www.fisheries.noaa.gov/grant/pacific-coastal-salmon-recovery-fund">Pacific Coastal Salmon Recovery Fund (PCSRF)</a>. </p>
